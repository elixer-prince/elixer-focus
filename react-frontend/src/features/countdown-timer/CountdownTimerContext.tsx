...
import tickingSoundURL from "@features/countdown-timer/assets/ticking-sound-effect.mp3";
import resetTimerSoundURL from "@features/countdown-timer/assets/reset-timer-sound-effect.mp3";
