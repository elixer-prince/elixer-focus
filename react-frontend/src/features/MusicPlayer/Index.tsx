...
const MusicPlayerContent = () => {
    ...
    return (
        <article
            className={
                "border-t-base-content/25 bg-base-100 fixed bottom-4 left-3 flex h-(--music-player-height) items-center gap-4 rounded-xl border-t-2 p-4 shadow-lg select-none"
            }
        >
