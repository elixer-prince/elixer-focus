...
const Task = ({
  ...
  return (
    <li
      ...
      className={`task bg-base-100 mr-3 flex cursor-grab items-center justify-between gap-1 rounded-md border px-3 py-2 select-none ${index === 0 ? "outline-primary outline" : ""} ${isSelected ? "border-primary" : "border-base-content/25"}`.trim()}
    >
